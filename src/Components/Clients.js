...
const Clients = () => {
  return (
    <div className="h-screen bg-[#26335D] mt-14 text-white  lg:w-[90rem] m-auto p-5">
        ...
        {/* Cards */}
        <div
          className="m-auto md:w-[50%] md:h-[40%] flex lg:flex-row flex-col justify-between lg:gap-5 items-center content-center lg:pt-10 md:mb-6"
        >
          ...
          <div className="bg-white lg:w-[45%] w-full h-[100%] my-10 py-5 px-5 flex flex-col items-center gap-3 m-auto">
            ...
            {/* img */}
            <div className="w-20 ml-5">
            <img src="/Assets/img/bar.svg" alt="red-bar"/>
            </div>
